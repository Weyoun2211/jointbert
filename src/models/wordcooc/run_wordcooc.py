...
def run_wordcooc(train_set, valid_set, test_set, feature_combinations, classifiers, experiment_name,dataset_name,
    ...
    os.makedirs(os.path.dirname(f'../../../reports/{dataset_name}/wordcooc/{experiment_name}/'),
                exist_ok=True)

    os.makedirs(os.path.dirname(f'../../../models/{dataset_name}/wordcooc/{experiment_name}/'),
                exist_ok=True)


    with open(f'../../../reports/{dataset_name}/wordcooc/{experiment_name}/{report_train_name}_{report_test_name}.csv',
              "w") as f:
        f.write(
        ...
        for feature_combination in feature_combinations:
            ...
            for k, v in classifiers.items():
                ...
                if write_test_set_for_inspection:
                    ...
                    out_path = f'../../../data/processed/inspection/{dataset_name}/wordcooc/{experiment_name}/'
                ...
                dump(model, f'../../../models/{dataset_name}/wordcooc/{experiment_name}/{report_train_name}_{report_test_name}_{k}_{feature_combination}_{run}.joblib')

                with open(f'../../../reports/{dataset_name}/wordcooc/{experiment_name}/{report_train_name}_{report_test_name}.csv', "a") as f:
...
if __name__ == '__main__':
    ...
    for train_size in train_sizes:
        ...
        file = f'../../../data/processed/wdc-lspc/wordcooc/new-testset/preprocessed_computers_train_{train_size}_wordcooc.pkl.gz'
        valid = file.replace('train_', 'valid_')

        test = f'../../../data/processed/wdc-lspc/wordcooc/new-testset/preprocessed_computers_train_{train_size}_wordcooc_preprocessed_computers_new_testset_1500.pkl.gz'
