...
def preprocess_wordcooc(file, columns_to_preprocess, feature_combinations, experiment_name, dataset_name, valid_set=None,
    ...
    out_path = f'../../../data/processed/{dataset_name}/wordcooc/{experiment_name}/'
...
if __name__ == '__main__':
    ...
    if BUILD_LSPC:
        ...
        files = [
            '../../../data/interim/wdc-lspc/training-sets/preprocessed_computers_train_xlarge.pkl.gz',
            '../../../data/interim/wdc-lspc/training-sets/preprocessed_computers_train_large.pkl.gz',
            '../../../data/interim/wdc-lspc/training-sets/preprocessed_computers_train_medium.pkl.gz',
            '../../../data/interim/wdc-lspc/training-sets/preprocessed_computers_train_small.pkl.gz',
        ]
        ...
        for file in files:
            ...
            test = '../../../data/interim/wdc-lspc/gold-standards/preprocessed_computers_new_testset_1500.pkl.gz'

            preprocess_wordcooc(file, columns_to_preprocess, feature_combinations, experiment_name='new-testset', dataset_name='wdc-lspc',
