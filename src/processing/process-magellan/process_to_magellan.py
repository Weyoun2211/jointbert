...
def preprocess_magellan(file, columns_to_preprocess, experiment_name, dataset_name, validation_set=None):
    ...
    out_path1 = f'../../../data/processed/{dataset_name}/magellan/{experiment_name}/'
    out_path2 = f'../../../data/processed/{dataset_name}/magellan/{experiment_name}/formatted/'
...
if __name__ == '__main__':
    if BUILD_LSPC:
        ...
        for file in glob.glob('../../../data/interim/wdc-lspc/training-sets/*'):
            ...
            preprocess_magellan(file, columns_to_preprocess, experiment_name='learning-curve', dataset_name='wdc-lspc', validation_set=valid)

        for file in glob.glob('../../../data/interim/wdc-lspc/gold-standards/*'):
            preprocess_magellan(file, columns_to_preprocess, experiment_name='learning-curve', dataset_name='wdc-lspc')

        # new testset
        columns_to_preprocess = ['title', 'description', 'brand', 'specTableContent']

        file = '../../../data/interim/wdc-lspc/gold-standards/preprocessed_computers_new_testset_1500.pkl.gz'
        preprocess_magellan(file, columns_to_preprocess, experiment_name='new-testset', dataset_name='wdc-lspc')
